...
public class Test02 {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            WebElement outerIframe = driver.findElement(By.id("iframe_rightMenu"));

            // 바깥쪽 iframe으로 전환
            driver.switchTo().frame(outerIframe);

            // 안쪽 iframe 찾기 (안쪽 iframe 내에서의 ID)
            WebElement innerIframe = driver.findElement(By.id("iframe_centerMenu1"));
            ...
            // ! ----------------------------------------------------------------------
            Thread.sleep(1000);
            WebElement btnElement = driver.findElement(By.id("btn_time"));
            ...
            List<WebElement> liElementList = driver.findElements(By.cssSelector("#ft-id-4 li .fancytree-checkbox"));
            ...
            WebElement chartElement = driver.findElement(By.id("divChartControll"));
            ...
            List<WebElement> trElementListFromThead = driver.findElements(By.cssSelector("#mainTableT thead tr"));
            for (WebElement trElement : trElementListFromThead) {
                List<WebElement> tdElementList = trElement.findElements(By.cssSelector("th"));
            ...
            List<WebElement> trList = driver.findElements(By.cssSelector("#mainTable tbody tr"));
